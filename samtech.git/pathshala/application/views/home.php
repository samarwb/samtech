...
<section id="mu-slider">
    ...
    <div class="mu-slider-single">
        ...
        <div class="mu-slider-content">
            <h4>Welcome To My Pathshala</h4>
            <span></span>
            <h2>We Will Help You To Learn</h2>
            <form>
                <input class="search_box" type="text" name="location" placeholder="Location"/>
                <input class="search_box" type="text" name="college" placeholder="College/Universities"/>
                <input class="search_box" type="text" name="course" placeholder="Course"/>
                <input type="submit" class="mu-read-more-btn" value="Search"/>
            </form>
    ...
    <div class="mu-slider-single">
        ...
        <div class="mu-slider-content">
            ...
            <form>
                <input class="search_box" type="text" name="location" placeholder="Location"/>
                <input class="search_box" type="text" name="college" placeholder="College/Universities name"/>
                <input class="search_box" type="text" name="course" placeholder="Course"/>
                <input type="submit" class="mu-read-more-btn" value="Search"/>
            </form>
        </div>
